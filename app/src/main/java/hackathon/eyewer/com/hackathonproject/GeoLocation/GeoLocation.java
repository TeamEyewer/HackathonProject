package hackathon.eyewer.com.hackathonproject.GeoLocation;
...
stopUsingGps       ==> stops update reciever
CanGetLocation     ==> returns boolean
getLatitude        ==> returns double latitude
getlongitude       ==> returns double lonitude
showSettingsAlert  ==> opens settings menu to enable gps
 */
